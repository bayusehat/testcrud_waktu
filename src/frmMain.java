...
String nol_menit="";
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Boulodrome", 0, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("SMK TELKOM MALANG");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(20, 10, 520, 30);

        labelwaktu.setText("jLabel4");
        jPanel1.add(labelwaktu);
        labelwaktu.setBounds(580, 10, 180, 20);

        labeltanggal1.setText("jLabel4");
        jPanel1.add(labeltanggal1);
        labeltanggal1.setBounds(580, 40, 180, 20);
        ...
        tfNis.setText("NIS");
        tfNis.setBorder(new javax.swing.border.MatteBorder(null));
        jPanel2.add(tfNis);
        tfNis.setBounds(10, 60, 210, 30);

        tfNama.setText("NAMA");
        tfNama.setBorder(new javax.swing.border.MatteBorder(null));
        ...
        jPanel2.add(rbLaki);
        rbLaki.setBounds(10, 260, 79, 23);

        buttonGroup1.add(rbPerempuan);
        rbPerempuan.setText("PEREMPUAN");
        jPanel2.add(rbPerempuan);
        rbPerempuan.setBounds(120, 260, 85, 23);

        tfEmail.setText("EMAIL");
        tfEmail.setBorder(new javax.swing.border.MatteBorder(null));
        ...
        jPanel2.add(tfEmail);
        tfEmail.setBounds(10, 330, 210, 30);

        taAlamat.setColumns(20);
        taAlamat.setFont(new java.awt.Font("Mongolian Baiti", 0, 13)); // NOI18N
        taAlamat.setRows(5);
        taAlamat.setText("ALAMAT LENGKAP");
        jScrollPane1.setViewportView(taAlamat);

        jPanel2.add(jScrollPane1);
        jScrollPane1.setBounds(10, 370, 210, 90);
        ...
        jPanel2.add(cbKelas);
        cbKelas.setBounds(10, 290, 210, 30);
        ...
        jPanel2.add(btnEdit);
        btnEdit.setBounds(130, 470, 80, 30);

        TPL.setText("TEMPAT LAHIR");
        jPanel2.add(TPL);
        TPL.setBounds(10, 140, 210, 30);
        jPanel2.add(TGL);
        TGL.setBounds(10, 210, 210, 40);

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("TANGGAL LAHIR");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(10, 180, 150, 30);

        getContentPane().add(jPanel2);
        jPanel2.setBounds(20, 80, 230, 510);
        ...
        btnPrint.setBounds(10, 10, 90, 30);

        getContentPane().add(jPanel3);
        jPanel3.setBounds(280, 80, 500, 50);
        ...
        jScrollPane2.setBounds(10, 9, 480, 350);

        getContentPane().add(jPanel4);
        jPanel4.setBounds(280, 140, 500, 370);

        setBounds(0, 0, 815, 634);
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if("".equals(tfNis.getText()) || "".equals(taAlamat.getText()) ||
                "".equals(cbKelas.getSelectedItem()) || "".equals(tfNama.getText()) || "".equals(tfEmail.getText())) {
            ...
            String SQL = "INSERT INTO t_siswa (NIS,NamaSiswa,JenisKelamin,Kelas,Email,Alamat)" 
                    ...
                    + tfEmail.getText()+"','"+taAlamat.getText()+"','"+TPL.getText()+"','"+tanggal;
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if("".equals(tfNis.getText()) || "".equals(taAlamat.getText()) ||
            ...
            String SQL = "UPDATE t_siswa SET "
                    + "NamaSiswa='"+tfNama.getText()+"', "+"JenisKelamin='"+JK+"', "
                    + "Kelas='"+cbKelas.getSelectedItem()+"', "+"Email='"+tfEmail.getText()+"', "
                    + "Alamat='"+taAlamat.getText()+"', "
                    + "NIS='"+tfNis.getText()+"Tempat Lahir='"+TPL.getText()+"',"+"'Tanggal lahir='"+tanggal+"',"+"' WHERE NIS='"+NIS+"'";
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        labelwaktu.setText(kal.format(skrg));
    }
    public void setJam(){
        ActionListener taskPerformer = new ActionListener(){
            public void actionPerformed(ActionEvent evt){
                ...
                labeltanggal1.setText("Jam "+jam+" : "+menit+" : "+detik);
            }
        };
